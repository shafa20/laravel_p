...
<form method="POST" action="{{ route('login') }}">
    ...
    <x-label for="email" :value="__('Email')" />
        ...
        <x-input id="email" placeholder="Enter Email Address" class=" fc-outline-dark form-control block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus />
    </div>
    ...
    <div class="mt-4 form-group">
        ...
        <x-input id="password" class="fc-outline-dark form-control"  type="password"
